    ...
    class SaveToPdf
    {
        public static void CreateDoc(PdfInfo info)
        {
            ...
            foreach (var order in info.Orders)
            {
                ...
                {
                    Table = table,
                    Texts = new List<string> { order.DateCreate.ToShortDateString(), order.DishName, order.Count.ToString(), order.Sum.ToString(), order.Status.ToString() },
                    Style = "Normal",
        ...
        public static void CreateDocAllOrders(PdfInfoOrdersAllDates info)
        {
            Document document = new Document();
            DefineStyles(document);
            Section section = document.AddSection();
